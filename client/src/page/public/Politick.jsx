import '../../styles/politick.css'
import Header from '../../components/Header'

export default function Politick() {
  return (
    <div>
    <Header/>
      <div className="privacy-policy">
          <div className="privacy-policy__content">
            ...
            <div className="privacy-section">
              ...
              <div className="privacy-subsection">
                <h3>1.2.</h3>
                <p>Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://kolos.</p>
              </div>
            </div>
            ...
            <div className="privacy-section">
              ...
              <div className="privacy-definition">
                <h3>2.1.</h3>
              ...
              <div className="privacy-definition">
                <h3>2.3.</h3>
                <p><strong>Веб-сайт</strong> — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://kolos.</p>
              </div>
              ...
              <div className="privacy-definition">
                <h3>2.8.</h3>
                <p><strong>Персональные данные</strong> — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://kolos.</p>
              </div>
              ...
              <div className="privacy-definition">
                <h3>2.10.</h3>
                <p><strong>Пользователь</strong> — любой посетитель веб-сайта https://kolos.</p>
              </div>
            ...
            <div className="privacy-section">
              ...
              <div className="privacy-subsection">
                <h3>12.1.</h3>
                <p>Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <strong>privacy@thismywebsite.com</strong>.</p>
              </div>
              ...
              <div className="privacy-subsection">
                <h3>12.3.</h3>
                <p>Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <strong>https://kolos/politick</strong>.</p>
              </div>
            </div>
